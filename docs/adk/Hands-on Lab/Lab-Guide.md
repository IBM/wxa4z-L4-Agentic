...
6. Once verified, navigate to the **Resource List** by clicking on the hamburger menu icon in the top-left corner and clicking on **Resources**. 
...
8.  Click on the resource shown for the **watsonx Orchestrate** resource: 
